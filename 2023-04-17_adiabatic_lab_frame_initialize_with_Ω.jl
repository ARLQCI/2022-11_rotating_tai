...
# # Lab Frame Observarbles for an Adiabatic Interferometric Scheme — Initialize with Ω 

# Here, we explore the expectation values of the full interferometer for a fully adiabatic time evolution. Compared to [2023-04-05_adiabatic_lab_frame.ipynb](2023-04-05_adiabatic_lab_frame.ipynb), we initalize the ground state including the value of the external Ω.
...
datadir(folders...) = joinpath(".", "data", "2023-04-17_adiabatic_lab_frame_initialize_with_Ω", folders...)
