...
# #  Full dynamics for guess pulse at `t_r=150μs`, `V0=0.2MHz`

# We create an animation for the Wigner guess pulse from the optimization for point (5) at 0.2 MHz in `2023-02-01_map_analysis.ipynb`.
...
datadir(folders...) = joinpath(".", "data", "2023-03-24_guess_full_scheme", folders...)
mkpath(datadir())
