...
# # Performance of the full optimized scheme for `t_r=150μs`, `V0=0.2MHz`, `R=26μm`, `ω₀=50π/s`
...
datadir(folders...) = joinpath(".", "data", "2023-05-17_optimized_full_scheme", folders...)
mkpath(datadir())
...
plot(Ω_vals / (π/sec), P_vals; label="opt", xlabel="Ω (π/sec)", ylabel="population (right)")
