...
# #  OCT for `t_r=150μs`, `V0=2.1MHz`

# We are optimizing for point (5) at 2.1 MHz in `2023-02-01_map_analysis.ipynb`. We are varying *only* ω(t), not V₀(t)
...
function map_observables(observables::PositionMomentumObservables, Ψ)
    map_observables(observables, nothing, 1, Ψ)
end
# -
